                            ...
                            <div class="tab-pane active" id='producto'>
                                <div class="card card-success">
                                    <div class="card-header" style="background: #114358cc;">
                                        <div class="card-title mt-2 mb-3">Crear compra</div>
                                    </div>
                                        ...
                                        <div class="card col-sm-9 p-3">
                                            ...
                                            <div class="alert alert-danger text-center" id="noadd-prod" style='display:none;'>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select  id="producto_select" class="form-control select2" style="width: 100%"></select>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group text-right">
                                                    <button class="agregar-producto btn btn-outline-success ml-2">Agregar</button>
                                                </div>
                                            </div>
                                        </div>
